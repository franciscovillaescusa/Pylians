...
# USAGE: python FoF_file_merger.py snapdir snapnum
...
parser.add_argument("snapnum", type=int, help="groups number")
...
FoF = readfof.FoF_catalog(snapdir, snapnum, 
                          long_ids=args.long_ids, swap=args.swap, SFR=args.SFR)
